...
if(isset($_GET['IdEstag'])){
  $sql2="Update Estagio  
  set id_aluno= $id_aluno".
  " where id_estagio=".$_GET['IdEstag'] . " and id_aluno=NULL";
...
$sql = "SELECT Estagio.id_estagio,Estagio.descricao,Estagio.local,Utilizador.nome,Estagio.estado
...
if (mysqli_num_rows($final) > 0) {
    ...
    while ($i = mysqli_fetch_assoc($final)) {
        ...
        echo "<tr><td>" . $i["descricao"] .
            ...
            "</td><td>" . $i["estado"] ;
            "</td><td>";
            echo "<a href='CEA.php?IdEstag=".$i['id_estagio']."'>Escolher</a>
            </td></tr>";
    }
  echo "</table>";
} else {
