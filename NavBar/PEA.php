...
if (isset($_POST['descricao'])) {
 ...
 //Query para insert
 $sql = "INSERT INTO Estagio (descricao,local,id_aluno,id_empresa)
 VALUES ('$descricao','$local','$id_aluno','$nomeemp')";
...
<nav class="navbar navbar-expand-sm bg-dark">
  ...
  <!-- Texto e outros -->
  <h1>Propostas de Estagio</h1>

<form action="/dosos/NavBar/PEA.php" method="POST">
    <p>
      <label> descricao </label>
      <textarea name="descricao"></textarea>
    </p><br>
    <label for="local">Local de estagio</label>
